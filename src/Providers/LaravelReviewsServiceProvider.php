...
namespace Faridlab\LaravelReviews\Providers;
...
class LaravelReviewsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-reviews');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-reviews');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/laravel-reviews'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'laravel-reviews');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/laravel-reviews'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \Faridlab\LaravelReviews\Console\Commands\LaravelReviewsCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/laravel-reviews'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/laravel-reviews.php', 'laravel-reviews'
        // );
    }
}
